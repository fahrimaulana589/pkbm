...
$confirmDelete = function ($id) {
    $this->id = $id;
    $this->dispatch('delete-program-confirmation');
};
...
<div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Program..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.program.create') }}"
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.program.edit', ['id' => $program->id]) }}"
    ...
    <x-confirm-modal :trigger="'delete-program-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Program ini akan dihapus. Apakah Anda yakin ingin menghapus program ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-program-confirmed'" :title="'Program berhasil dihapus'" :message="'Program ini telah dihapus.'" />
