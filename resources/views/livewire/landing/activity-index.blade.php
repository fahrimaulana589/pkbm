...
<section id="activity" class="py-16 sm:py-20 bg-white dark:bg-navy-900 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-base text-primary font-semibold tracking-wide uppercase">Kegiatan</h2>
            ...
            <p class="mt-4 max-w-2xl text-xl text-slate-500 dark:text-slate-300 mx-auto">
                Berbagai kegiatan seru dan edukatif yang telah dilaksanakan di
                {{ $profile->nama_pkbm ?? 'PKBM SekolahKita' }}.
            </p>
        </div>
        ...
        <div class="relative">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
                ...
                @forelse($galleries as $gallery)
                    <a href="/kegiatan/{{ $gallery->id }}" wire:navigate.hover
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-slate-900 dark:text-white">Belum ada kegiatan</h3>
                        <p class="mt-2 text-slate-500 dark:text-slate-400">
                            Dokumentasi kegiatan belum tersedia saat ini.
                        </p>
                    </div>
                @endforelse
            </div>
        ...
        <div class="mt-12">
            {{ $galleries->links(data: ['scrollTo' => '#activity']) }}
        </div>
    </div>
</section>