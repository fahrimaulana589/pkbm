                    ...
                    @foreach($classes as $class)
                        <a href="/jadwal/kelas/{{ $class->id }}" wire:navigate
                            ...
                            <div class="p-6">
                                ...
                                <h4 class="text-xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-primary transition-colors">
                                    {{ $class->nama_rombel }}
                                </h4>
                ...
                <div class="text-center py-12">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-100 dark:bg-navy-700 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 0 011 1v5m-4 0h4" />
                        </svg>
                    </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid gap-6 lg:grid-cols-3 sm:grid-cols-2">
                            @foreach($dailySchedules as $schedule)
                                <div class="bg-white dark:bg-navy-800 rounded-xl shadow-sm border border-slate-100 dark:border-navy-700 overflow-hidden hover:shadow-md transition-shadow duration-300">
                                    <div class="p-6">
                                        <div class="flex items-center justify-between mb-4">
                                            <span class="px-3 py-1 text-xs font-semibold rounded-full bg-primary/10 text-primary">
                                        ...
                                        @if($schedule->classGroup && $schedule->classGroup->tutor)
                                            <div class="flex items-center mt-4 pt-4 border-t border-slate-100 dark:border-navy-700">
                                                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-slate-200 dark:bg-navy-600 flex items-center justify-center text-sm font-bold text-slate-600 dark:text-slate-300">
