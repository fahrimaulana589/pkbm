...
state(['code' => '', 'result' => null, 'feedbackMessage' => '', 'activePpdb' => null]);
    ...
    <div class="card p-4 sm:p-5">
        ...
        @else
            <div class="flex flex-col items-center justify-center py-10 text-center">
                ...
                <p class="text-slate-500 mt-2">Saat ini tidak ada periode PPDB yang sedang aktif. Silakan kembali lagi
                    nanti.</p>
            </div>
        @endif
    </div>
