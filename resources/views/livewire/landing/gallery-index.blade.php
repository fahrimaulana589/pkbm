...
<section id="gallery" class="py-16 sm:py-20 bg-white dark:bg-navy-900 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-slate-900 dark:text-white">Belum ada album galeri</h3>
                        <p class="mt-2 text-slate-500 dark:text-slate-400">
                            Album kegiatan terbaru belum tersedia saat ini.
                        </p>
                    </div>
                @endforelse
            </div>
        ...
        <div class="mt-12">
            {{ $galleries->links(data: ['scrollTo' => '#gallery']) }}
        </div>
    </div>
</section>