...
mount(function ($id) {
    ...
    $this->nama_lengkap = $this->student->nama_lengkap;
    $this->tempat_lahir = $this->student->tempat_lahir;
    $this->tanggal_lahir = $this->student->tanggal_lahir ? $this->student->tanggal_lahir->format('Y-m-d') : '';
    $this->jenis_kelamin = $this->student->jenis_kelamin;
    $this->alamat = $this->student->alamat;
    $this->no_hp = $this->student->no_hp;
    $this->status = $this->student->status;
});

rules(fn() => [
    'program_id' => 'required|exists:programs,id',
    'nik' => ['required', 'string', 'max:16', Rule::unique('students')->ignore($this->student->id)],
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Perbarui detail informasi warga belajar.
                </p>
    ...
    <x-success-modal trigger="student-updated" message="Data warga belajar berhasil diperbarui." />
</div>