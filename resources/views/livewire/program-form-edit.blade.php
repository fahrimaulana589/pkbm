...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Perbarui detail informasi program pendidikan.
                </p>
    ...
    <x-success-modal trigger="program-updated" message="Data program berhasil diperbarui." />
</div>