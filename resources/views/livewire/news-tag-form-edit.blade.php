...
mount(function ($id) {
    $this->tag = NewsTag::findOrFail($id);
    $this->nama_tag = $this->tag->nama_tag;
...
$save = function () {
    ...
    $exists = NewsTag::where('slug', $this->slug)
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Perbarui detail informasi tag berita.
                </p>
    ...
    <x-success-modal trigger="tag-updated" message="Data tag berhasil diperbarui." />
</div>