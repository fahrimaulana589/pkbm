...
$classGroups = computed(function () {
    return ClassGroup::with(['program', 'tutor'])
        ...
        ->orWhereHas('tutor', function ($query) {
...
<div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Rombel..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.rombel.create') }}"
            ...
            <div class="card mt-3">
                <div x-data="{
                    ...
                    <table class="is-hoverable w-full text-left">
                        ...
                        <tbody>
                            @foreach ($this->classGroups as $index => $rombel)
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.rombel.edit', ['id' => $rombel->id]) }}"
                                                        ...
                                                        <li><button @click="isShowPopper = false"
                                                                wire:click="confirmDelete('{{$rombel->id}}')"
    ...
    <x-confirm-modal :trigger="'delete-class-group-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Rombel ini akan dihapus. Apakah Anda yakin ingin menghapus data ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-class-group-confirmed'" :title="'Rombel berhasil dihapus'" :message="'Data rombel telah dihapus.'" />
