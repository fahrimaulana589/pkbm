...
mount(function ($id) {
    ...
    $this->name = $this->ppdb->name;
    $this->tahun = $this->ppdb->tahun;
    $this->status = $this->ppdb->status;
    $this->start_date = $this->ppdb->start_date ? \Carbon\Carbon::parse($this->ppdb->start_date)->format('Y-m-d') : '';
    $this->end_date = $this->ppdb->end_date ? \Carbon\Carbon::parse($this->ppdb->end_date)->format('Y-m-d') : '';
});
...
$save = function () {
    ...
    session()->flash('message', 'Data PPDB berhasil diperbarui.');
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Perbarui detail informasi PPDB.
                </p>
