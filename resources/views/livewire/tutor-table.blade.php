...
$tutors = computed(function () {
    return Tutor::where('nama', 'like', '%' . $this->search . '%')
...
<div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Tutor..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.tutor.create') }}"
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.tutor.edit', ['id' => $tutor->id]) }}"
                                                        ...
                                                        <li><button @click="isShowPopper = false"
                                                                wire:click="confirmDelete('{{$tutor->id}}')"
    ...
    <x-confirm-modal :trigger="'delete-tutor-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Tutor ini akan dihapus. Apakah Anda yakin ingin menghapus tutor ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-tutor-confirmed'" :title="'Tutor berhasil dihapus'" :message="'Tutor ini telah dihapus.'" />
