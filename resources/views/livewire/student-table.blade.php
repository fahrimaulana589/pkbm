...
$getStatusBadge = fn($status) => match ($status) {
    ...
    'lulus' => '<div class="badge rounded-full bg-info/10 text-info dark:bg-info/15">Lulus</div>',
...
$confirmDelete = function ($id) {
    $this->id = $id;
    $this->dispatch('delete-student-confirmation');
};
...
<div>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.student.create') }}"
    ...
    <x-confirm-modal :trigger="'delete-student-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Warga belajar ini akan dihapus. Apakah Anda yakin ingin menghapus data ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-student-confirmed'" :title="'Warga belajar berhasil dihapus'" :message="'Data warga belajar telah dihapus.'" />
