...
mount(function ($id) {
    $this->classGroup = ClassGroup::findOrFail($id);
    $this->programs = Program::where('status', 'aktif')->get();
    $this->tutors = Tutor::where('status', 'aktif')->get();

    $this->program_id = $this->classGroup->program_id;
    $this->tutor_id = $this->classGroup->tutor_id;
    $this->nama_rombel = $this->classGroup->nama_rombel;
    $this->periode = $this->classGroup->periode;
});
...
$save = function () {
    ...
    $this->dispatch('class-group-updated');
};
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Perbarui detail informasi rombel.
                </p>
    ...
    <x-success-modal trigger="class-group-updated" message="Data rombel berhasil diperbarui." />
</div>