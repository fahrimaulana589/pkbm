...
$save = function () {
    ...
    session()->flash('status', 'Tutor berhasil dibuat');
    session()->flash('message', 'Data tutor berhasil ditambahkan.');
    return $this->redirectRoute('admin.tutor.index', navigate: true);
};
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
    <div class="col-span-12 lg:col-span-8">
        <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
                <p>
                    Isi detail informasi tutor baru.
                </p>
