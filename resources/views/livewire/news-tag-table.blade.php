...
$confirmDelete = function ($id) {
    $this->id = $id;
    $this->dispatch('delete-tag-confirmation');
};
...
<div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Tag..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.tag-berita.create') }}"
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.tag-berita.edit', ['id' => $tag->id]) }}"
    ...
    <x-confirm-modal :trigger="'delete-tag-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Tag ini akan dihapus. Apakah Anda yakin ingin menghapus data ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-tag-confirmed'" :title="'Tag berhasil dihapus'" :message="'Data tag telah dihapus.'" />
