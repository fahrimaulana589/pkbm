...
$confirmDelete = function ($id) {
    $this->id = $id;
    $this->dispatch('delete-category-confirmation');
};

$delete = function () {
    NewsCategory::find($this->id)->delete();
    $this->categories = NewsCategory::orderBy('created_at', 'desc')->get();
    $this->dispatch('delete-category-confirmed');
};

// Search Logic
$updatedSearch = function () {
    $this->categories = NewsCategory::where('nama_kategori', 'like', '%' . $this->search . '%')
        ...
        <div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Kategori..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.kategori-berita.create') }}"
            ...
            <div class="card mt-3">
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.kategori-berita.edit', ['id' => $category->id]) }}"
                ...
                <div
                    ...
                    <div class="text-xs-plus">Menampilkan {{ $this->categories->count() }} dari
                        {{ $this->categories->count() }} entri</div>
                </div>
            </div>
        </div>
    </div>

    <x-confirm-modal :trigger="'delete-category-confirmation'" :title="'Konfirmasi Penghapusan'" :message="'Kategori ini akan dihapus. Apakah Anda yakin ingin menghapus data ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-category-confirmed'" :title="'Kategori berhasil dihapus'" :message="'Data kategori telah dihapus.'" />
