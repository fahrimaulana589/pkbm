...
<div>
                    ...
                    <div class="flex items-center" x-data="{isInputActive:false}">
                        <label class="block">
                            <input wire:model.live.debounce.250ms="search"
                                ...
                                placeholder="Cari Sertifikat..." type="text" />
                        </label>
                    ...
                    <div x-data="usePopper({placement:'bottom-end',offset:4})"
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li><a wire:navigate.hover href="{{ route('admin.sertifikat.create') }}"
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="text-slate-700 dark:text-navy-100">
                                            {{ $certificate->student->nama_lengkap ?? '-' }}
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="text-slate-700 dark:text-navy-100">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="text-slate-700 dark:text-navy-100">
                                            {{ $certificate->tanggal->format('d/m/Y') }}
                                        </div>
                                    </td>
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li><a wire:navigate.hover
                                                                href="{{ route('admin.sertifikat.edit', ['id' => $certificate->id]) }}"
    ...
    <x-confirm-modal :trigger="'delete-certificate-confirmation'" :title="'Konfirmasi Penghapusan'"
        :message="'Sertifikat ini akan dihapus. Apakah Anda yakin ingin menghapus data ini?'" :action="'delete'" />

    <x-success-modal :trigger="'delete-certificate-confirmed'" :title="'Sertifikat berhasil dihapus'" :message="'Data sertifikat telah dihapus.'" />
